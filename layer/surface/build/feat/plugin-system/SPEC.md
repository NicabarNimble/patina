...
| 2026-02-12 | release-gate | Session [[20260212-140036]]: v0.17.0 release gate audit — SHIP IT. 0 critical, 0 important, 2 minor, 3 nit. All 18 findings from 2 prior audits resolved (12 fixed, 4 deferred to Phase 3, 2 unchanged). Binary: +16.3 MB from wasmtime (50 MB → 66 MB). 24 tests (22 plugin + 2 registry), all pass. 10 edge-case scenarios walked + Jon Gjengset lens. See audit: `layer/surface/reports/audit/2026-02-12-plugin-system-v17-release-gate.md`. |
