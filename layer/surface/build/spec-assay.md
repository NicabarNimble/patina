...
**Status:** Deferred to [spec-work-deferred.md](spec-work-deferred.md#assay-snapshot-subcommand)

Phase 0 covers core use cases. Snapshot is an edge case for audit workflows - revisit when needed.
