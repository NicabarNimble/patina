...
echo "$(date +"%H:%M")" > .opencode/context/.last-update
...
echo ""
if [ -f ".opencode/context/last-session.md" ]; then
    echo "Please read .opencode/context/last-session.md and fill in the Previous Session Context section above."
else
