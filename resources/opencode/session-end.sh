...
LAST_SESSION_FILE=".opencode/context/last-session.md"
...
cp "$ACTIVE_SESSION" ".opencode/context/sessions/${SESSION_ID}.md"
...
if [ "$SILENT_MODE" = false ]; then
    ...
    echo "  - .opencode/context/sessions/${SESSION_ID}.md"
