...
fn sync_claude_adapter(dry_run: bool) -> Result<()> {
    ...
    let files_to_sync = vec![
        ...
        ("resources/claude/session-update.sh", "Session update script"),
        ("resources/claude/session-end.sh", "Session end script"),
        ("resources/claude/session-note.sh", "Session note script"),
        ("resources/claude/commands/session-start", "Session start command"),
        ("resources/claude/commands/session-update", "Session update command"),
        ("resources/claude/commands/session-end", "Session end command"),
        ("resources/claude/commands/session-note", "Session note command"),
    ];
