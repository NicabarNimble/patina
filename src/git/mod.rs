...
pub use operations::{
    ...
    has_remote, has_upstream, head_sha, is_clean, is_diverged, is_git_repo, last_commit_message,
    last_commit_relative_time, log_oneline, rebase, rebase_abort, remote_url, repo_name, short_sha,
    stash_push, status_count, status_porcelain, tag_exists,
};
