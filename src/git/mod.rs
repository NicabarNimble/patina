...
pub use operations::{
    ...
    create_tag, create_tag_at, current_branch, default_branch, diff_stat_summary, fetch,
    files_changed_since, has_merge_conflicts, has_remote, has_staged_changes, has_upstream,
    head_sha, is_clean, is_clean_tracked, is_diverged, is_git_repo, last_commit_message,
    last_commit_relative_time, list_matching_tags, log_oneline, rebase, rebase_abort, remote_url,
